...
class mit_b0(MixVisionTransformer):
    def __init__(self, pretrained=False):
        ...
        if pretrained:
            ...
            self.load_state_dict(torch.load("./model/model_data/b0_backbone_weights.pth"), strict=False)
...
class mit_b1(MixVisionTransformer):
    def __init__(self, pretrained=False):
        ...
        if pretrained:
            print("Load backbone weights")
            self.load_state_dict(torch.load("./model/model_data/b1_backbone_weights.pth"), strict=False)
